...
class TDivision(typing.Protocol):
    ...
    @classmethod
    def from_dict(cls, id: typing.Optional[int] = None, name: typing.Optional[str] = None, employees: typing.Optional[typing.Sequence["EmployeeDict"]] = None) -> "TDivision":
        """
...
class TEmployee(typing.Protocol):
    ...
    @classmethod
    def from_dict(cls, id: typing.Optional[int] = None, name: typing.Optional[str] = None) -> "TEmployee":
        """
        Construct from a dictionary (eg. a POST payload).
