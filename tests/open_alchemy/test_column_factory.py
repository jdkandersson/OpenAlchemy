...
def test_spec_to_column_no_type():
    ...
    with pytest.raises(exceptions.TypeMissingError):
        column_factory.column._spec_to_column(spec={})
...
def test_spec_to_column_type_unsupported():
    ...
    with pytest.raises(exceptions.FeatureNotImplementedError):
        column_factory.column._spec_to_column(spec={"type": "unsupported"})
...
def test_spec_to_column_column_return():
    ...
    """
    column = column_factory.column._spec_to_column(spec={"type": "number"})
...
def test_spec_to_column_primary_key(primary_key: bool):
    ...
    """
    column = column_factory.column._spec_to_column(
...
def test_spec_to_column_index(index: bool):
    ...
    """
    column = column_factory.column._spec_to_column(
        spec={"type": "number", "x-index": index}
    )
...
def test_spec_to_column_nullable(
    ...
    column = column_factory.column._spec_to_column(spec=schema, **kwargs)
...
def test_spec_to_column_number_double():
    ...
    """
    with pytest.raises(exceptions.FeatureNotImplementedError):
        column_factory.column._spec_to_column(
...
def test_spec_to_column_number_unsupported_format():
    ...
    with pytest.raises(exceptions.FeatureNotImplementedError):
        column_factory.column._spec_to_column(
            spec={"type": "number", "format": "unsupported"}
        )
...
def test_spec_to_column_integer():
    ...
    """
    column = column_factory.column._spec_to_column(spec={"type": "integer"})
...
def test_spec_to_column_string():
    ...
    """
    column = column_factory.column._spec_to_column(spec={"type": "string"})
...
def test_spec_to_column_boolean():
    ...
    """
    column = column_factory.column._spec_to_column(spec={"type": "boolean"})
