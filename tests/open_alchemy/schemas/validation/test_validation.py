...
CHECK_TESTS = [
    ...
    #     {"result": {"valid": True}, "models": {"Schema1": {"result": {"valid": False}}}},
    #     id="single model model not valid"
    # ),
    # pytest.param(
    #     {"components": {"schemas": {"Schema1": {"type": "object", "x-tablename": "schema_1", "properties": {"prop_1": {}}}}}},
    #     {"result": {"valid": True}, "models": {"Schema1": {"result": {"valid": True}, "properties": {"prop_1": {"result": {"valid": False}}}}}},
    #     id="single model properties not valid"
    # ),
    # pytest.param(
    #     {"components": {"schemas": {"Schema1": {"type": "object", "x-tablename": "schema_1", "properties": {"prop_1": {"type": "integer"}}}}}},
    #     {"result": {"valid": True}, "models": {"Schema1": {"result": {"valid": True}, "properties": {"prop_1": {"result": {"valid": True}}}}}},
    #     id="single model valid"
    # ),
    # pytest.param(
    #     {"components": {"schemas": {"Schema1": {"type": "object", "x-tablename": "schema_1", "properties": {"prop_1": {}, "prop_2": {"type": "integer"}}}}}},
    #     {"result": {"valid": True}, "models": {"Schema1": {"result": {"valid": True}, "properties": {"prop_1": {"result": {"valid": False}}, "prop_2": {"result": {"valid": True}}}}}},
    #     id="single model multiple properties first invalid"
    # ),
    # pytest.param(
    #     {"components": {"schemas": {"Schema1": {"type": "object", "x-tablename": "schema_1", "properties": {"prop_1": {"type": "integer"}, "prop_2": {}}}}}},
    #     {"result": {"valid": True}, "models": {"Schema1": {"result": {"valid": True}, "properties": {"prop_1": {"result": {"valid": True}}, "prop_2": {"result": {"valid": False}}}}}},
    #     id="single model multiple properties second invalid"
    # ),
    # pytest.param(
    #     {"components": {"schemas": {"Schema1": {"type": "object", "x-tablename": "schema_1", "properties": {"prop_1": {"type": "integer"}, "prop_2": {"type": "integer"}}}}}},
    #     {"result": {"valid": True}, "models": {"Schema1": {"result": {"valid": True}, "properties": {"prop_1": {"result": {"valid": True}}, "prop_2": {"result": {"valid": True}}}}}},
    #     id="single model multiple properties valid"
    # ),
    # pytest.param(
    #     {"components": {"schemas": {
    #         True: {"type": "object", "x-tablename": "schema_1", "properties": {"prop_1": {"type": "integer"}}},
    #         "Schema2": {"type": "object", "x-tablename": "schema_2", "properties": {"prop_1": {"type": "integer"}}},
    #     }}},
    #     {"result": {"valid": False}},
    ...
    # pytest.param(
    #     {"components": {"schemas": {
    #         "Schema1": {"type": "object", "x-tablename": "schema_1", "properties": {"prop_1": {"type": "integer"}}},
    #         True: {"type": "object", "x-tablename": "schema_2", "properties": {"prop_1": {"type": "integer"}}},
    #     }}},
    #     {"result": {"valid": False}},
    ...
    #         "Schema1": {"result": {"valid": False}},
    #         "Schema2": {"result": {"valid": True}, "properties": {"prop_2": {"result": {"valid": True}}}},
    #     }},
    ...
    #     }}},
    #     {"result": {"valid": True}, "models": {
    #         "Schema1": {"result": {"valid": True}, "properties": {"prop_1": {"result": {"valid": True}}}},
    #         "Schema2": {"result": {"valid": False}},
    #     }},
